<div class="box form">
    ...
    <form id="frm_edit_profile" method="post">
        ...
        <field name="ui_theme" type="select" caption="Theme" value="[[$_SESSION@ui_theme]]" list="$list_themes" />
        <field name="date_format" type="select" caption="Date format" value="[[$_SESSION@date_format]]" list="$list_date_formats" />
