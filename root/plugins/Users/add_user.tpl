<div class="box form">
    ...
    <form id="frm_add_user" method="post">
        ...
        <field name="user" type="textbox" caption="Username" value="[[$user_data@user]]" />
        ...
        <h2>Call settings</h2>
        <field name="extension" type="textbox" caption="Extension" tip="e.g. 100" value="[[$user_data@extension]]" />
        ...
        <h2>Password</h2>
        <field name="password" type="textbox" caption="Password" value="[[$user_data@password]]" />
