<div class="box form">
<h1><?=$action!='edit' ? 'New' : 'Edit' ?> CDR route entry</h1>
<form id="cnam_frm_add" action="" method="post">
	...
	<input class="{{is|"$h_name"|highlight}}"name="name" type="text" value="{{$f_name}}"/><br />
	
	<label for="type">Route type :</label>
	<input class="{{is|"$h_type"|highlight}}" name="type" type="text" value="{{$f_type}}"/><br />
