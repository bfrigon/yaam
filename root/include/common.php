...
require(DOCUMENT_ROOT . '/include/class.PluginBaseTable.php');
...
{
	$pgroups = $_SESSION['pgroups'];

	switch ($req_perm) {
		case 'manager':
			if (strstr($pgroups, 'manager') !== false)
				return true;
			
			break;
	}

	return (strstr($pgroups, 'admin') !== false);
}
